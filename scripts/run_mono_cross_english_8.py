...
loss_functions = ["MultipleNegativesRankingLoss"]
batch_sizes = [256]
epochs = [1]
sample_sizes = [500, 1000, 2000, 3000, 4000, 5000, 6000, 8000, 10000, 15000] # 500, 1000, 2000, 3000, 4000, 5000, 6000, 8000, 10000, 20000
...
results_dir = "/mnt/home/robinmeister/mono_cross_english_8/results"
...
def generate_results_file(dataset1, noise_rate1, model_name, loss_fn, batch_size, epochs):
    return f"{model_name}_{loss_fn}_{dataset1}_{noise_rate1}_mono_cross_english_8_batches_bs{batch_size}_ep{epochs}.csv"
...
for (dataset1, model_name, loss_fn, batch_size, epoch,
    ...
    command = (f"python main_mono_cross_english_8.py --path_to_datasets {path_to_datasets} --dataset1 {dataset1} "
