...
log_dir = "/mnt/home/robinmeister/mono_cross/logs"
model_dir = "/mnt/home/robinmeister/mono_cross/models"
...
def prepare_training_data(df_de_de, df_fr_fr, df_de_fr, df_fr_de, model_name, column_pairs):
    ...
    # Define training examples for de -> fr_005
    ...
    # Define training examples for fr -> de_005
    ...
    balanced_examples = [
        example for quad in zip(training_examples_de_de, training_examples_fr_fr, training_examples_de_fr, training_examples_fr_de) for example in quad
    ]
...
def main(args):
    ...
    for sample_size in sample_sizes:
        ...
        combined_train_dataloader = prepare_training_data(df1_de_de, df1_fr_fr, df1_de_fr, df1_fr_de, args.model_name, column_pairs1)
