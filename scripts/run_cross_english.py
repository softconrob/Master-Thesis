...
batch_sizes = [8]
epochs = [1]
sample_sizes = [30000] # 500, 1000, 2000, 3000, 4000, 5000, 6000, 8000, 10000, 20000
...
results_dir = "/mnt/home/robinmeister/cross_english/results"
...
def generate_results_file(dataset1, noise_rate1, model_name, loss_fn, batch_size, epochs):
    return f"{model_name}_{loss_fn}_cross_english_batches_bs{batch_size}.csv"
...
for (dataset1, model_name, loss_fn, batch_size, epoch,
    ...
    command = (f"python main_cross_english.py --path_to_datasets {path_to_datasets} --dataset1 {dataset1} "
