...
results_dir = "/mnt/home/robinmeister/mono_cross/results"
...
def generate_results_file(dataset1, noise_rate1, model_name, loss_fn, batch_size, epochs):
    return f"{model_name}_{loss_fn}_{dataset1}_{noise_rate1}_mono_cross_batches_bs{batch_size}_ep{epochs}.csv"
...
for (dataset1, model_name, loss_fn, batch_size, epoch,
    ...
    command = (f"python main_mono_cross.py --path_to_datasets {path_to_datasets} --dataset1 {dataset1} "
