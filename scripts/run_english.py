...
results_dir = "/mnt/home/robinmeister/english/results"
...
def generate_results_file(dataset1, noise_rate1, model_name, loss_fn, batch_size, epochs):
    return f"{model_name}_{loss_fn}_{dataset1}_{noise_rate1}_english_batches_bs{batch_size}_ep{epochs}.csv"
...
for (dataset1, model_name, loss_fn, batch_size, epoch,
    ...
    command = (f"python main_english.py --path_to_datasets {path_to_datasets} --dataset1 {dataset1} "
